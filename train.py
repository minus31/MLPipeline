...
class SamplesVisualisationLogger(pl.Callback):
    def __init__(self, datamodule):
        ...
        # self.datamodule.setup(stage='wrong_sample_visualization')
...
def main(cfg):
    print("In main function ", os.getcwd())
    ...
    checkpoint_callback = ModelCheckpoint(
        dirpath=os.path.join(get_original_cwd(), "models"),
    ...
    wandb_logger = WandbLogger(project="MLOps_Test", entity="minus31")
